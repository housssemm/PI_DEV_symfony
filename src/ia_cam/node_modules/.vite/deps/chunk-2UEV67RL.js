  ...
  "node_modules/@mediapipe/pose/pose.js"(exports) {
    (function() {
      ...
      J("Symbol", function(a) {
        ...
        function c(g, e) {
          this.g = g;
          ca(this, "description", { configurable: true, writable: true, value: e });
        }
        if (a) return a;
      ...
      function ta(a, b, c, d) {
        try {
          ...
          if (!f.done) return a.g.l = false, f;
          var g = f.value;
        } catch (e) {
          return a.g.i = null, qa(a.g, e), ua(a);
        }
        a.g.i = null;
        d.call(a.g, g);
        return ua(a);
      ...
      function va(a) {
        this.next = function(b) {
          pa(a.g);
          a.g.i ? b = ta(a, a.g.i.next, b, a.g.o) : (a.g.o(b), b = ua(a));
          return b;
        };
        this.throw = function(b) {
          pa(a.g);
          a.g.i ? b = ta(a, a.g.i["throw"], b, a.g.o) : (qa(a.g, b), b = ua(a));
          return b;
        };
      ...
      J("Promise", function(a) {
        ...
        b.prototype.u = function(e) {
          ...
          "function" == typeof h ? this.G(h, e) : this.m(e);
        };
        ...
        b.prototype.B = function() {
          ...
          var e = G.CustomEvent, h = G.Event, k = G.dispatchEvent;
          if ("undefined" === typeof k) return true;
          "function" === typeof e ? e = new e("unhandledrejection", { cancelable: true }) : "function" === typeof h ? e = new h("unhandledrejection", { cancelable: true }) : (e = G.document.createEvent("CustomEvent"), e.initCustomEvent("unhandledrejection", false, true, e));
          e.promise = this;
          e.reason = this.i;
          return k(e);
        };
        ...
        b.prototype.F = function(e) {
          var h = this.j();
          e.J(h.resolve, h.reject);
        };
        b.prototype.G = function(e, h) {
          var k = this.j();
          try {
        ...
        b.race = function(e) {
          return new b(function(h, k) {
            for (var l = M(e), n = l.next(); !n.done; n = l.next()) d(n.value).J(h, k);
          });
        };
        b.all = function(e) {
          var h = M(e), k = h.next();
          return k.done ? d([]) : new b(function(l, n) {
            ...
            var w = [], t = 0;
            do
              w.push(void 0), t++, d(k.value).J(v(w.length - 1), n), k = h.next();
            while (!k.done);
          });
        };
        return b;
          ...
          for (var c = 0, d = new Uint8Array(3 * a.length), f = 0; f < a.length; f++) {
            ...
            if (128 > g) d[c++] = g;
              ...
              if (2048 > g) d[c++] = g >> 6 | 192;
                ...
                if (55296 <= g && 57343 >= g) {
                  if (56319 >= g && f < a.length) {
                    var e = a.charCodeAt(++f);
                    if (56320 <= e && 57343 >= e) {
                      g = 1024 * (g - 55296) + e - 56320 + 65536;
                      d[c++] = g >> 18 | 240;
                      d[c++] = g >> 12 & 63 | 128;
                      d[c++] = g >> 6 & 63 | 128;
                      d[c++] = g & 63 | 128;
      ...
      function Ha(a, b) {
        ...
        Ia();
        b = Fa[b];
        for (var c = Array(Math.floor(a.length / 3)), d = b[64] || "", f = 0, g = 0; f < a.length - 2; f += 3) {
          var e = a[f], h = a[f + 1], k = a[f + 2], l = b[e >> 2];
          e = b[(e & 3) << 4 | h >> 4];
          h = b[(h & 15) << 2 | k >> 6];
          k = b[k & 63];
          c[g++] = l + e + h + k;
        ...
        switch (a.length - f) {
          ...
          case 1:
            a = a[f], c[g] = b[a >> 2] + b[(a & 3) << 4 | l >> 4] + k + d;
        }
        return c.join("");
      }
      function Ka(a) {
      ...
      function Xa(a, b, c) {
        var d = a.g.i, f = Ra(a.g), g = a.g.g + f;
        a.g.i = g;
        c(b, a);
        c = g - a.g.g;
        if (0 !== c) throw Error("Message parsing ended unexpectedly. Expected to read " + f + " bytes, instead read " + (f - c) + " bytes, either the data ended unexpectedly or the message misreported its own length");
        a.g.g = g;
        a.g.i = d;
        return b;
      }
      function Ya(a) {
        ...
        a = a.h;
        var d;
        if (Ba) (d = Aa) || (d = Aa = new TextDecoder("utf-8", { fatal: false })), d = d.decode(a.subarray(c, c + b));
        else {
          b = c + b;
          for (var f = [], g = null, e, h, k; c < b; ) e = a[c++], 128 > e ? f.push(e) : 224 > e ? c >= b ? f.push(65533) : (h = a[c++], 194 > e || 128 !== (h & 192) ? (c--, f.push(65533)) : f.push((e & 31) << 6 | h & 63)) : 240 > e ? c >= b - 1 ? f.push(65533) : (h = a[c++], 128 !== (h & 192) || 224 === e && 160 > h || 237 === e && 160 <= h || 128 !== ((d = a[c++]) & 192) ? (c--, f.push(65533)) : f.push((e & 15) << 12 | (h & 63) << 6 | d & 63)) : 244 >= e ? c >= b - 2 ? f.push(65533) : (h = a[c++], 128 !== (h & 192) || 0 !== (e << 28) + (h - 144) >> 30 || 128 !== ((d = a[c++]) & 192) || 128 !== ((k = a[c++]) & 192) ? (c--, f.push(65533)) : (e = (e & 7) << 18 | (h & 63) << 12 | (d & 63) << 6 | k & 63, e -= 65536, f.push((e >> 10 & 1023) + 55296, (e & 1023) + 56320))) : f.push(65533), 8192 <= f.length && (g = za(g, f), f.length = 0);
          d = za(g, f);
        }
        return d;
      }
      ...
      function ab(a) {
        ...
        b = new Uint8Array(b);
        for (var c = a.h, d = c.length, f = 0, g = 0; g < d; g++) {
          var e = c[g];
      ...
      function cb(a, b, c) {
        if (null != a) return "object" === typeof a ? bb && a instanceof Uint8Array ? c(a) : db(a, b, c) : b(a);
      }
      function db(a, b, c) {
        if (Array.isArray(a)) {
          for (var d = Array(a.length), f = 0; f < a.length; f++) d[f] = cb(a[f], b, c);
      ...
      function V(a, b, c) {
        ...
        a: {
          d = this.g.length;
          a = d - 1;
          if (d && (d = this.g[a], !(null === d || "object" != typeof d || Array.isArray(d) || bb && d instanceof Uint8Array))) {
            this.l = a - this.j;
            this.h = d;
            break a;
          }
        ...
        if (c) for (b = 0; b < c.length; b++) a = c[b], a < this.l ? (a += this.j, (d = this.g[a]) ? eb(d) : this.g[a] = ib) : (jb(this), (d = this.h[a]) ? eb(d) : this.h[a] = ib);
      }
      ...
      function nb(a, b) {
        if (a.i) for (var c in a.i) {
          var d = a.i[c];
          if (Array.isArray(d)) for (var f = 0; f < d.length; f++) d[f] && nb(d[f], b);
          else d && nb(d, b);
        }
        return a.g;
      }
      ...
      function Cb(a) {
        return lb(a, sb).map(function(b) {
          return { index: ob(b, 1), Y: Y(b, 2), label: null != W(b, 3) ? pb(b, 3) : void 0, displayName: null != W(b, 4) ? pb(b, 4) : void 0 };
        });
      }
      ;
      function Db(a) {
      ...
      function Eb(a) {
        a: {
          var b = new yb();
          for (a = new Ua(a); Va(a); ) switch (a.i) {
            case 10:
              var c = Xa(a, new wb(), xb);
              mb(b, c, wb, void 0);
              break;
            default:
              if (!rb(b, a)) break a;
      ...
      ;
      var Jb = new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 9, 1, 7, 0, 65, 0, 253, 15, 26, 11]);
      function Kb(a, b) {
        return b + a;
      }
      function Lb(a, b) {
      ...
      function Nb() {
        return Z(this, function b() {
          return O(b, function(c) {
            switch (c.g) {
              case 1:
                return c.m = 2, N(c, WebAssembly.instantiate(Jb), 4);
              case 4:
                c.g = 3;
                c.m = 0;
                break;
      ...
      function Ob(a) {
        ...
        this.P = "";
        this.B = {};
        this.locateFile = a && a.locateFile || Kb;
      ...
      function Qb(a) {
        return Z(a, function c() {
          var d = this, f, g, e, h, k, l, n, v, w, t, y;
          return O(c, function(m) {
            switch (m.g) {
              ...
              case 2:
                e = m.h;
                if ("object" === typeof window) return Lb("createMediapipeSolutionsWasm", { locateFile: d.locateFile }), Lb("createMediapipeSolutionsPackedAssets", { locateFile: d.locateFile }), l = g.filter(function(u) {
                  return void 0 !== u.data;
                }), n = g.filter(function(u) {
                  return void 0 === u.data;
                  ...
                  return x;
                })), w = Promise.all(n.map(function(u) {
                  return void 0 === u.simd || u.simd && e || !u.simd && !e ? Mb(f.locateFile(u.url, f.S)) : Promise.resolve();
                })).then(function() {
                  return Z(f, function x() {
                    var z, E, F = this;
                    return O(x, function(K) {
                      if (1 == K.g) return z = window.createMediapipeSolutionsWasm, E = window.createMediapipeSolutionsPackedAssets, N(K, z(E), 2);
                      F.h = K.h;
                      K.g = 0;
                    });
                  });
                  ...
                  return Z(f, function x() {
                    ...
                    return O(x, function(E) {
                      z.g.graph && z.g.graph.url ? E = N(E, Rb(z, z.g.graph.url), 0) : (E.g = 0, E = void 0);
                      return E;
                    });
                  });
        ...
        return Z(a, function c() {
          ...
          return O(c, function(w) {
            if (1 == w.g) {
              ...
              d.P = d.g.graph.url;
              return N(w, Rb(d, d.g.graph.url), 3);
            }
            2 != w.g && (f = w.h, d.i.loadGraph(f));
            g = M(Object.keys(d.B));
            for (e = g.next(); !e.done; e = g.next()) h = e.value, d.i.overrideFile(h, d.B[h]);
            d.B = {};
            if (d.g.listeners) for (k = M(d.g.listeners), l = k.next(); !l.done; l = k.next()) n = l.value, Tb(d, n);
            v = d.j;
            d.j = {};
            d.setOptions(v);
            w.g = 0;
      ...
      D.setOptions = function(a, b) {
        ...
        if (b = b || this.g.options) {
          for (var d = [], f = [], g = {}, e = M(Object.keys(a)), h = e.next(); !h.done; g = { K: g.K, L: g.L }, h = e.next()) {
            ...
            }(g))), h.graphOptionXref && (k = { valueNumber: 1 === h.type ? a[k] : 0, valueBoolean: 0 === h.type ? a[k] : false, valueString: 2 === h.type ? a[k] : "" }, h = Object.assign(Object.assign(Object.assign({}, { calculatorName: "", calculatorIndex: 0 }), h.graphOptionXref), k), f.push(h))));
          }
          if (0 !== d.length || 0 !== f.length) this.o = true, this.A = (void 0 === this.A ? [] : this.A).concat(f), this.u = (void 0 === this.u ? [] : this.u).concat(d);
        }
      };
      function Ub(a) {
        return Z(a, function c() {
          var d = this, f, g, e, h, k, l, n;
      ...
      D.initialize = function() {
        return Z(this, function b() {
          var c = this;
          return O(b, function(d) {
            return 1 == d.g ? N(d, Qb(c), 2) : 3 != d.g ? N(d, Sb(c), 3) : N(d, Ub(c), 0);
          });
        });
      };
      function Rb(a, b) {
        return Z(a, function d() {
          ...
          return O(d, function(h) {
            if (b in f.F) return h.return(f.F[b]);
            g = f.locateFile(b, "");
            e = fetch(g).then(function(k) {
          ...
          return O(d, function(y) {
            switch (y.g) {
              ...
              case 3:
                ...
                h = M(Object.keys(a));
                for (k = h.next(); !k.done; k = h.next()) if (l = k.value, n = f.g.inputs[l]) {
                  a: {
                    var m = f;
                    var u = a[l];
                    switch (n.type) {
                      case "video":
                        var x = m.m[n.stream];
                        x || (x = new Fb(m.h, m.D), m.m[n.stream] = x);
                        m = x;
                        0 === m.l && (m.l = m.h.createTexture());
                        if ("undefined" !== typeof HTMLVideoElement && u instanceof HTMLVideoElement) {
                          var z = u.videoWidth;
                          x = u.videoHeight;
                        } else "undefined" !== typeof HTMLImageElement && u instanceof HTMLImageElement ? (z = u.naturalWidth, x = u.naturalHeight) : (z = u.width, x = u.height);
                      ...
                      case "detections":
                        ...
                        for (x = 0; x < u.length; ++x) {
                          ...
                          if (null != C && null != C) {
                            ...
                            B = Math.abs(B);
                            var q = B >>> 0;
                            B = Math.floor((B - q) / 4294967296);
                            B >>>= 0;
                            C && (B = ~B >>> 0, q = (~q >>> 0) + 1, 4294967295 < q && (q = 0, B++, 4294967295 < B && (B = 0)));
                            Q = q;
                            R = B;
                            C = Q;
                            for (q = R; 0 < q || 127 < C; ) r.push(C & 127 | 128), C = (C >>> 7 | q << 25) >>> 0, q >>>= 7;
                            r.push(C);
                          }
                          qb(p, A);
                          I = ab(I);
                          F.call(E, K, I);
                          if (z.O) for (E = 0; E < z.O.length; ++E) p = z.O[E], A = p.visibility ? true : false, F = m.data, K = F.addNormalizedLandmark, I = x, p = Object.assign(Object.assign({}, p), { visibility: A ? p.visibility : 0 }), A = new wb(), X(A, 1, p.x), X(A, 2, p.y), X(A, 3, p.z), p.visibility && X(A, 4, p.visibility), r = p = new Za(), U(r, 1, W(A, 1)), U(r, 2, W(A, 2)), U(r, 3, W(A, 3)), U(r, 4, W(A, 4)), U(r, 5, W(A, 5)), qb(A, r), p = ab(p), K.call(F, I, p);
                          if (z.M) for (E = 0; E < z.M.length; ++E) {
                            ...
                            r = p = new Za();
                            q = W(A, 1);
                            if (null != q && null != q) if (T(r.g, 8), C = r.g, 0 <= q) T(C, q);
                            else {
                              for (B = 0; 9 > B; B++) C.push(q & 127 | 128), q >>= 7;
                              C.push(1);
                            }
                            U(r, 2, W(A, 2));
                            C = W(A, 3);
                            null != C && (C = Ea(C), T(r.g, 26), T(r.g, C.length), $a(r, r.g.end()), $a(r, C));
                            C = W(A, 4);
                            null != C && (C = Ea(C), T(r.g, 34), T(r.g, C.length), $a(r, r.g.end()), $a(
                              r,
                              C
                            ));
                            qb(A, r);
                  ...
                  switch (n.type) {
                    case "video":
                      e.pushTexture2d(Object.assign(Object.assign({}, v), { stream: w, timestamp: g }));
                      break;
                    case "detections":
                      t = v;
                      t.stream = w;
      ...
      function Vb(a, b, c) {
        return Z(a, function f() {
          var g, e, h, k, l, n, v = this, w, t, y, m, u, x, z, E;
          return O(f, function(F) {
            switch (F.g) {
              case 1:
                ...
                e = 0;
                h = M(Object.keys(c));
                for (k = h.next(); !k.done; k = h.next()) l = k.value, n = c[l], "string" !== typeof n && "texture" === n.type && void 0 !== b[n.stream] && ++e;
                1 < e && (v.G = false);
                w = M(Object.keys(c));
                k = w.next();
              case 2:
                ...
                t = k.value;
                y = c[t];
                if ("string" === typeof y) return z = g, E = t, N(F, Wb(v, t, b[y]), 14);
                m = b[y.stream];
                if ("detection_list" === y.type) {
                  if (m) {
                    var K = m.getRectList();
                    for (var I = m.getLandmarksList(), p = m.getClassificationsList(), A = [], C = 0; C < K.size(); ++C) {
                      var r = K.get(C);
                      a: {
                        var B = new Ab();
                        for (r = new Ua(r); Va(r); ) switch (r.i) {
                          case 13:
                            var q = S(r.g);
                            X(B, 1, q);
                            break;
                          ...
                          case 45:
                            ...
                            break;
                          case 48:
                            for (var H = r.g, L = 128, Ja = 0, aa = q = 0; 4 > aa && 128 <= L; aa++) L = H.h[H.g++], Ja |= (L & 127) << 7 * aa;
                            128 <= L && (L = H.h[H.g++], Ja |= (L & 127) << 28, q |= (L & 127) >> 4);
                            if (128 <= L) for (aa = 0; 5 > aa && 128 <= L; aa++) L = H.h[H.g++], q |= (L & 127) << 7 * aa + 3;
                            if (128 > L) {
                              H = Ja >>> 0;
                              L = q >>> 0;
                              if (q = L & 2147483648) H = ~H + 1 >>> 0, L = ~L >>> 0, 0 == H && (L = L + 1 >>> 0);
                              H = 4294967296 * L + (H >>> 0);
                              q = q ? -H : H;
                            } else H.l = true, q = void 0;
                            X(B, 6, q);
                            break;
                          default:
                            if (!rb(B, r)) break a;
                      ...
                      B = { Z: Y(B, 1), $: Y(B, 2), height: Y(B, 3), width: Y(B, 4), rotation: Y(B, 5, 0), X: ob(B, 6) };
                      r = Eb(I.get(C));
                      H = p.get(C);
                      a: for (q = new ub(), H = new Ua(H); Va(H); ) switch (H.i) {
                        case 10:
                          q.addClassification(Xa(H, new sb(), tb));
                          break;
                        default:
                          if (!rb(q, H)) break a;
                      }
                ...
                u = v.s[t];
                u || (u = new Fb(v.h, v.D), v.s[t] = u);
                return N(F, Gb(u, m, v.G), 13);
              case 13:
                x = F.h, g[t] = x;
              case 7:
                y.transform && g[t] && (g[t] = y.transform(g[t]));
                F.g = 3;
                break;
              case 14:
                z[E] = F.h;
      ...
      function Wb(a, b, c) {
        return Z(a, function f() {
          ...
          return O(f, function(h) {
            return "number" === typeof c || c instanceof Uint8Array || c instanceof g.h.Uint8BlobList ? h.return(c) : c instanceof g.h.Texture2dDataOut ? (e = g.s[b], e || (e = new Fb(g.h, g.D), g.s[b] = e), h.return(Gb(e, c, g.G))) : h.return(void 0);
          });
        });
      }
      function Tb(a, b) {
        for (var c = b.name || "$", d = [].concat(fa(b.wants)), f = new a.h.StringList(), g = M(b.wants), e = g.next(); !e.done; e = g.next()) f.push_back(e.value);
        g = a.h.PacketListener.implement({ onResults: function(h) {
          for (var k = {}, l = 0; l < b.wants.length; ++l) k[d[l]] = h.get(l);
          var n = a.listeners[c];
          n && (a.C = Vb(a, k, b.outs).then(function(v) {
            v = n(v);
      ...
      function Yb(a) {
        var b = this;
        a = a || {};
        this.g = new Ob({ locateFile: a.locateFile, files: function(c) {
          return [{ url: "pose_solution_packed_assets_loader.js" }, { simd: false, url: "pose_solution_wasm_bin.js" }, { simd: true, url: "pose_solution_simd_wasm_bin.js" }, { data: true, url: Xb(c.modelComplexity) }];
          ...
          transform: Eb
        }, poseWorldLandmarks: { type: "proto", stream: "world_landmarks", transform: Eb }, segmentationMask: { type: "texture", stream: "segmentation_mask" } } }], inputs: { image: { type: "video", stream: "input_frames_gpu" } }, options: {
          ...
          modelComplexity: { type: 1, graphOptionXref: { calculatorType: "ConstantSidePacketCalculator", calculatorName: "ConstantSidePacketCalculatorModelComplexity", fieldName: "int_value" }, onChange: function(c) {
            return Z(b, function f() {
              ...
              return O(f, function(l) {
                if (1 == l.g) return g = Xb(c), e = "third_party/mediapipe/modules/pose_landmark/" + g, N(l, Rb(h.g, g), 2);
                k = l.h;
                h.g.overrideFile(e, k);
      ...
      P("POSE_LANDMARKS_RIGHT", { RIGHT_EYE_INNER: 4, RIGHT_EYE: 5, RIGHT_EYE_OUTER: 6, RIGHT_EAR: 8, RIGHT_LEFT: 10, RIGHT_SHOULDER: 12, RIGHT_ELBOW: 14, RIGHT_WRIST: 16, RIGHT_PINKY: 18, RIGHT_INDEX: 20, RIGHT_THUMB: 22, RIGHT_HIP: 24, RIGHT_KNEE: 26, RIGHT_ANKLE: 28, RIGHT_HEEL: 30, RIGHT_FOOT_INDEX: 32 });
      P("POSE_LANDMARKS_NEUTRAL", { NOSE: 0 });
      P("VERSION", "0.4.1633558788");
    }).call(exports);
  }
});
...
//# sourceMappingURL=chunk-2UEV67RL.js.map
